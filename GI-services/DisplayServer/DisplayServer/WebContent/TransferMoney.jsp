                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                            <div class="dash__pad-2">
                                                ...
                                                <form class="dash-address-manipulation" method="GET" action="TransferTreatment.jsp">
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="address-fname">NIC Sender *</label>

                                                            <input name="sender" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Section Name"></div>

                                                        <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="address-fname">NIC Receiver *</label>
    
                                                                <input name="receiver" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Section Name"></div>

                                                    </div>
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="address-fname">Amount *</label>

                                                            <input name="amount" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Section Name"></div>

                                                        <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="address-fname">Currency *</label>
    
                                                                <input name="currency" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Section Name"></div>
