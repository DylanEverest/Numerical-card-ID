                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                            <div class="dash__pad-2">
                                                ...
                                                <h1 class="dash__h1 u-s-m-b-14">Enter NIC and the Adress</h1>

                                                <span class="dash__text u-s-m-b-30">Search information</span>
                                                <form class="dash-address-manipulation" method="POST" action="InsertPersonProp.jsp">
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="address-fname">NIC *</label>

                                                            <input name="NIC" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Nic"></div>

                                                            <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="address-fname">Adress *</label>
    
                                                                <input name="Adress" class="input-text input-text--primary-style" type="text" id="address-fname" placeholder="Adress name"></div>
